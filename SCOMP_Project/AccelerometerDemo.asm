...
ORG 0
	CALL SetupI2C
Start:
	CALL   ReadX		; Read Acceleration in X direction
	STORE  L2A			; Stores this value into L2A
	CALL   ReadY		; Read Acceleration in Y direction
	STORE  L2B			; Stores this value into L2B
	CALL   L2Estimate	; Estimates the Euclidian Acceleration
	SHIFT  -4			; Divides the result by 16 to reduce noise
	OUT    LEDs			; Outputs the result to the LEDs
	JUMP   Start   		; Repeat
